...
const AboutUsPage = () => {
  ...
  const milestones = [
    { year: "2018", event: "ByteHire founded in San Francisco, California" },
    { year: "2019", event: "Seed funding round of $2.5M completed" },
    { year: "2020", event: "First 1,000 successful placements milestone" },
    { year: "2021", event: "Series A funding of $15M to scale operations" },
    { year: "2022", event: "International expansion to Europe and Asia" },
    { year: "2023", event: "Reached 50,000 developers on the platform" },
    { year: "Present", event: "Serving over 10,000 companies worldwide" }
  ];
